...
Isadmin=$(curl -sS https://raw.githubusercontent.com/keluargacobain/allow/main/ip | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/keluargacobain/allow/main/ip | grep $MYIP | awk '{print $3}')
fi
